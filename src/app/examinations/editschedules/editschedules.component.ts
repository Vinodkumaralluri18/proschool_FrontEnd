...
export class EditschedulesComponent implements OnInit {
  ...
  editExam_schedules() {
    if(this.scheduleForm.value.unique_code === undefined || this.scheduleForm.value.unique_code === "" ||
      this.scheduleForm.value.from_date === undefined || this.scheduleForm.value.from_date === "" ||
      this.scheduleForm.value.end_date === undefined || this.scheduleForm.value.end_date === "" ) {
        this.alert_message = "Please Enter All Required Details";
